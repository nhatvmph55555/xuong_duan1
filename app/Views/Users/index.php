...
<head>
    <meta charset="utf-8">
    <title>N4 Fashion - Ultimate</title>
...
<body class="preload-wrapper popup-loader">
                                        ...
                                        <div class="collection-item style-left hover-img">
                                            <div class="collection-inner">
                                                <a href="<?=BASE_URL?>?act=shop&category_id=<?=$value->id?>" class="collection-image img-style">
                                                    <img class="lazyload" data-src="assets/Users/images/collections/009furniture-banner-05.jpg" src="assets/Users/images/collections/009furniture-banner-05.jpg" alt="collection-img">
                                                </a>
    ...
    <!-- canvasSearch -->
    <?php include 'app/Views/Users/layouts/search-product.php'; ?>
    <!-- /canvasSearch -->
