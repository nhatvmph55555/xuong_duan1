<div class="header-dashboard">
    <div class="wrap">
        <div class="header-left">
            <a href="index.html">
                <img class="" id="logo_header_mobile" alt="" src="assets/Admin/images/logo/logo.png" data-light="assets/Admin/images/logo/logo.png" data-dark="assets/Admin/images/logo/logo.png">
            </a>
                            ...
                            <ul>
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="assets/Admin/images/products/product-1.jpg" alt="">
                                    </div>
                                ...
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="assets/Admin/images/products/product-2.jpg" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                ...
                                <li class="product-item gap14">
                                    <div class="image no-bg">
                                        <img src="assets/Admin/images/products/product-3.jpg" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                    ...
                    <ul class="">
                        ...
                        <li>
                            <ul>
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="assets/Admin/images/products/product-4.jpg" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                ...
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="assets/Admin/images/products/product-5.jpg" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                ...
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="assets/Admin/images/products/product-6.jpg" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                ...
                                <li class="product-item gap14">
                                    <div class="image no-bg">
                                        <img src="assets/Admin/images/products/product-7.jpg" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                            <a href="product-list.html" class="body-text">Jersey thong body</a>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="assets/Admin/images/customers/customer-1.jpg" alt="">
                                </div>
                                <div class="flex-grow">
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="assets/Admin/images/customers/customer-2.jpg" alt="">
                                </div>
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="assets/Admin/images/customers/customer-3.jpg" alt="">
                                </div>
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4">
                        ...
                        <li>
                            <ul class="list-apps">
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-1.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-2.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-3.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-4.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-5.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-6.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-7.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-8.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="assets/Admin/images/apps/item-9.png" alt="">
                                    </div>
                                    <a href="#">
