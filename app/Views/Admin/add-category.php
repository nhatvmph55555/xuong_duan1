                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <form class="form-add-new-user form-style-2" action="<?= BASE_URL ?>?role=admin&act=add-post-category" method="post" enctype="multipart/form-data">
                                    <div class="wg-box">
                                        <div class="left">
                                            <h5 class="mb-4">Category</h5>
                                            <div class="body-text">Fill in the information below to add a new category</div>
                                        </div>
                                        <div class="right flex-grow">
                                            <fieldset class="name mb-24">
                                                <div class="body-title mb-10">Name</div>
                                                <input class="flex-grow" type="text" placeholder="Username Category" name="name"  value=""  >
                                            </fieldset>
                                     
                                    <div class="bot">
                                        <button class="tf-button w180" type="submit">Thêm mới category</button>
                                    </div>
