            ...
            <div class="login-page">
                <div class="left">
                    <div class="login-box">
                        ...
                        <form class="form-login flex flex-column gap22 w-full" action="<?= BASE_URL ?>?role=admin&act=post-login" method="post">
                            <fieldset class="email">
                                <div class="body-title mb-10 text-white">Email address <span class="tf-color-1">*</span></div>
                                <input class="flex-grow" type="email" placeholder="Enter your email address" name="email" tabindex="0" value="john@example.com" aria-required="true" required="">
                            </fieldset>
                            <fieldset class="password">
                                <div class="body-title mb-10 text-white">Password <span class="tf-color-1">*</span></div>
                                <input class="password-input" type="password" placeholder="Enter your password" name="password" tabindex="0" value="123456" aria-required="true" required="">
                                <span class="show-pass">
                                    <i class="assets/Admin/icon/-eye view"></i>
                                    <i class="assets/Admin/icon/-eye-off hide"></i>
                                </span>
                            </fieldset>
