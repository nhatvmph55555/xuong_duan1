                                ...
                                <form action="<?= BASE_URL ?>?role=admin&act=update-post-category&id=<?= $_GET['id'] ?>" method="post">
                                    <div class="wg-box">
                                        <div class="left">
                                            ...
                                            <div class="body-text">Fill in the information below to update category</div>
                                        </div>
                                        <div class="right flex-grow">
                                            <fieldset class="name mb-24">
                                                <div class="body-title mb-10">Name</div>
                                                <input class="flex-grow" type="text" placeholder="Username Category" name="name" value="<?= $category->name ?>" required="">
                                            </fieldset>
                                        </div>
                                        <div class="bot">
                                            <button class="tf-button w180" type="submit">Cập nhật category</button>
                                        </div>
                                    </div>
                                </form>
