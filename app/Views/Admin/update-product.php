                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <form class="form-add-product" action="<?= BASE_URL ?>?role=admin&act=update-post-product&id=<?=$_GET['id']?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="wg-box mb-30">
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="text" placeholder="Enter title" name="name" value="<?= $product->name ?>" required="">
                                        </fieldset>
                                        ...
                                        <div class="cols-lg gap22">
                                            <fieldset class="price">
                                                ...
                                                <input class="" type="number" placeholder="Price" name="price" value="<?= $product->price ?>" required="">
                                            </fieldset>
                                            <fieldset class="sale-price">
                                                <div class="body-title mb-10">Sale Price </div>
                                                <input class="" type="number" placeholder="Sale Price " name="price_sale" value="<?= $product->price_sale ?>">
                                            </fieldset>
                                        </div>
                                        <div class="cols-lg gap22">
                                        ...
                                        <div class="cols-lg gap22">
                                            <fieldset class="category">
                                                ...
                                                <input class="" type="text" placeholder="Enter Stock" name="stock" value="<?= $product->stock ?>" required="">
                                            </fieldset>
                                        </div>
                                        <fieldset class="description">
                                            <div class="body-title mb-10">Description <span class="tf-color-1">*</span></div>
                                            <textarea class="mb-10" name="description" placeholder="Short description about product" required=""><?= $product->description ?></textarea>
                                        </fieldset>
                                    </div>
