                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <form action="<?= BASE_URL ?>?role=admin&act=update-post-user&id=<?= $_GET['id'] ?>" method="post" enctype="multipart/form-data">
                                    <div class="wg-box">
                                        ...
                                        <div class="right flex-grow">
                                            <fieldset class="name mb-24">
                                                ...
                                                <input class="flex-grow" type="text" placeholder="Username" name="name" value="<?= $user->name ?>" required="">
                                            </fieldset>
                                            <fieldset class="email mb-24">
                                                <div class="body-title mb-10">Email</div>
                                                <input class="flex-grow" type="email" placeholder="Email" name="email" value="<?= $user->email ?>" required="">
                                            </fieldset>
                                            ...
                                            <fieldset class="name mb-24">
                                                ...
                                                <input class="flex-grow" type="text" placeholder="Address" name="address" value="<?= $user->address ?>" required="">
                                            </fieldset>
                                            <fieldset class="name mb-24">
                                                <div class="body-title mb-10">Phone</div>
                                                <input class="flex-grow" type="text" placeholder="Number phone" name="phone" value="<?= $user->phone ?>" required="">
                                            </fieldset>
                                            <fieldset class="name mb-24">
                                    ...
                                    <div class="bot">
                                        <button class="tf-button w180" type="submit">Chỉnh sửa</button>
                                    </div>
                                </form>
