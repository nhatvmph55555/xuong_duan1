                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <form class="form-add-new-user form-style-2" enctype="multipart/form-data">
                                    <div class="wg-box">
                                        <div class="right flex-grow">
                                            <fieldset class="name mb-24">
                                                <div class="body-title mb-10">Name</div>
                                                <input class="flex-grow" type="text" placeholder="Username" name="name" value="<?= $user->name ?>" required="" readonly>
                                            </fieldset>
                                            <fieldset class="email mb-24">
                                                <div class="body-title mb-10">Email</div>
                                                <input class="flex-grow" type="email" placeholder="Email" name="email" value="<?= $user->email ?>" required="" readonly>
                                            </fieldset>
                                            <fieldset class="password mb-24">
                                                <div class="body-title mb-10">Password</div>
                                                <input class="password-input" type="password" placeholder="Enter password" name="password" value=""  readonly>
                                            ...
                                            <fieldset class="name mb-24">
                                                ...
                                                <input class="flex-grow" type="text" placeholder="Address" name="address" value="<?= $user->address ?>" required="" readonly>
                                            </fieldset>
                                            <fieldset class="name mb-24">
                                                <div class="body-title mb-10">Phone</div>
                                                <input class="flex-grow" type="text" placeholder="Number phone" name="phone" value="<?= $user->phone ?>" required="" readonly>
                                            </fieldset>
                                            <fieldset class="name mb-24">
                                            ...
                                            <fieldset class="name mb-24">
                                                ...
                                                <input class="flex-grow" type="text" placeholder="Number phone" name="phone" value="<?php
                                                        if ($user->role == "1") {
                                                            echo "Admin";
                                                        }elseif ($user->role == "2") {
                                                            echo "User";
