                                        ...
                                        <ul class="flex flex-column">
                                            <?php foreach ($listUser as $key => $value): ?>
                                                ...
                                                <li class="wg-product item-row gap20">
                                                    ...
                                                    <div class="body-text text-main-dark mt-4" style="width: 100px; height: 100px;"><img src="<?= $value->image ?>" alt="" style="max-width: 100%; max-height: 100%;"></div>
                                                    ...
                                                    <div class="list-icon-function">
                                                        ...
                                                        <div class="item trash">
                                                            <a href="<?= BASE_URL ?>?role=admin&act=delete-user&id=<?= $value->id ?>" onclick="confirm('Bạn muốn xóa chứ???')">
