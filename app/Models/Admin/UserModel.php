...
class UserModel
{
    ...
    public function addUserToDB($destPath)
    {
        ...
        $sql = "INSERT INTO `users`( `name`, `email`, `password`, `address`, `phone`, `image`, `created_at`, `updated_at`, `role`) VALUES (:name,:email,:password,:address,:phone,:image,:created_at,:updated_at,:role)";
